...
echo "<VirtualHost _default_:80>" > $HTTPD_FALLBACK_CONF_FOLDER/001-http-backend.conf
echo "<VirtualHost _default_:443>" > $HTTPD_FALLBACK_CONF_FOLDER/002-https-backend.conf
